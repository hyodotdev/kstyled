...
// Card Container
export const Card = styledComponents(View)<{ index: number }>`
  width: 100%;
  align-self: stretch;
...
// Card Header
export const CardHeader = styledComponents(View)`
  flex-direction: row;
...
export const CardImage = styledComponents(Image)`
  width: 48px;
  height: 48px;
  border-radius: 24px;
  margin-right: 12px;
...
export const CardTitle = styledComponents.Text<{ priority: 'high' | 'medium' | 'low' }>`
  flex: 1;
  font-size: 18px;
  font-weight: 700;
...
export const CardBadge = styledComponents.View<{ type: 'new' | 'hot' | 'sale' }>`
  padding: 4px 12px;
  border-radius: 12px;
...
export const CardBadgeText = styledComponents(Text)`
  font-size: 11px;
  font-weight: 700;
  color: #FFFFFF;
...
// Card Content
export const CardContent = styledComponents(View)`
  gap: 12px;
`;

export const InfoRow = styledComponents(View)`
  flex-direction: row;
  align-items: center;
  gap: 8px;
`;

export const InfoIcon = styledComponents.View<{ color: string }>`
  width: 32px;
  height: 32px;
  border-radius: 16px;
...
export const InfoIconText = styledComponents(Text)`
  font-size: 16px;
`;

export const InfoContent = styledComponents(View)`
  flex: 1;
`;

export const InfoTitle = styledComponents(Text)`
  font-size: 14px;
  font-weight: 600;
  color: #000000;
  margin-bottom: 2px;
...
export const InfoSubtitle = styledComponents(Text)`
  font-size: 12px;
  color: #8E8E93;
`;

// Progress Bar
export const ProgressBar = styledComponents(View)`
  height: 8px;
...
export const ProgressFill = styledComponents(View)<{ color: string }>`
  height: 100%;
  background-color: ${(p: { color: string }) => p.color};
  border-radius: 4px;
`;
...
// Tags
export const TagsContainer = styledComponents(View)`
  flex-direction: row;
  gap: 8px;
  flex-wrap: wrap;
`;

export const Tag = styledComponents(Pressable)<{ variant: 'primary' | 'secondary' | 'success'; selected?: boolean }>`
  padding: 6px 12px;
  border-radius: 8px;
...
export const TagText = styledComponents.Text<{ variant: 'primary' | 'secondary' | 'success'; selected?: boolean }>`
  font-size: 12px;
  font-weight: 600;
...
// Card Footer
export const CardFooter = styledComponents(View)`
  flex-direction: row;
  justify-content: space-between;
  align-items: center;
  margin-top: 12px;
...
export const FooterText = styledComponents.Text<{ bold?: boolean }>`
  font-size: 13px;
  font-weight: ${(p: { bold?: boolean }) => p.bold ? '700' : '400'};
  color: ${(p: { bold?: boolean }) => p.bold ? '#000000' : '#8E8E93'};
`;

export const ActionButton = styledComponents(Pressable)<{ variant: 'primary' | 'secondary' }>`
  padding: 8px 16px;
  border-radius: 8px;
...
export const ActionButtonText = styledComponents.Text<{ variant: 'primary' | 'secondary' }>`
  font-size: 13px;
  font-weight: 600;
...
export const StaticCard = styledComponents(View)`
  width: 100%;
  border-radius: 12px;
  margin-bottom: 12px;
  overflow: hidden;
...
export const StaticCardBackground = styledComponents(ImageBackground)`
  width: 100%;
  padding: 16px;
  background-color: #FFFFFF;
`;

export const StaticHeader = styledComponents(View)`
  flex-direction: row;
  align-items: center;
  margin-bottom: 12px;
`;

export const StaticTitle = styledComponents(Text)`
  font-size: 18px;
  font-weight: 700;
  color: #000000;
  margin-bottom: 4px;
...
export const StaticSubtitle = styledComponents(Text)`
  font-size: 13px;
  color: #8E8E93;
  margin-bottom: 12px;
`;

export const StaticDescription = styledComponents(Text)`
  font-size: 14px;
  color: #333333;
  line-height: 22px;
  margin-bottom: 8px;
...
export const StaticHighlight = styledComponents(Text)`
  font-weight: 700;
  color: #007AFF;
`;

export const StaticWarning = styledComponents(Text)`
  font-weight: 700;
  color: #FF9500;
`;

export const StaticSuccess = styledComponents(Text)`
  font-weight: 700;
  color: #34C759;
`;

export const StaticMetaRow = styledComponents(View)`
  flex-direction: row;
  justify-content: space-between;
  align-items: center;
  margin-top: 8px;
...
export const StaticMetaText = styledComponents(Text)`
  font-size: 12px;
  color: #8E8E93;
`;
