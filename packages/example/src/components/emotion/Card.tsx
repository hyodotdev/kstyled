...
// Card Container
export const Card = styled(View)<{ index: number }>`
  width: 100%;
  align-self: stretch;
...
export const CardTitle = styled(Text)<{ priority: 'high' | 'medium' | 'low' }>`
  flex: 1;
  font-size: 18px;
  font-weight: 700;
...
export const CardBadge = styled(View)<{ type: 'new' | 'hot' | 'sale' }>`
  padding: 4px 12px;
  border-radius: 12px;
...
export const InfoIcon = styled(View)<{ color: string }>`
  width: 32px;
  height: 32px;
  border-radius: 16px;
...
export const ProgressFill = styled(View)<{ color: string }>`
  height: 100%;
  background-color: ${(p: { color: string }) => p.color};
  border-radius: 4px;
`;
...
export const Tag = styled(Pressable)<{ variant: 'primary' | 'secondary' | 'success'; selected?: boolean }>`
  padding: 6px 12px;
  border-radius: 8px;
...
export const TagText = styled(Text)<{ variant: 'primary' | 'secondary' | 'success'; selected?: boolean }>`
  font-size: 12px;
  font-weight: 600;
...
export const FooterText = styled(Text)<{ bold?: boolean }>`
  font-size: 13px;
  font-weight: ${(p: { bold?: boolean }) => p.bold ? '700' : '400'};
  color: ${(p: { bold?: boolean }) => p.bold ? '#000000' : '#8E8E93'};
`;

export const ActionButton = styled(Pressable)<{ variant: 'primary' | 'secondary' }>`
  padding: 8px 16px;
  border-radius: 8px;
...
export const StaticCardBackground = styled(ImageBackground)`
  width: 100%;
  padding: 16px;
  background-color: #FFFFFF;
`;

export const StaticHeader = styled(View)`
  flex-direction: row;
  align-items: center;
  margin-bottom: 12px;
`;

export const StaticTitle = styled(Text)`
  font-size: 18px;
  font-weight: 700;
  color: #000000;
  margin-bottom: 4px;
...
export const StaticSubtitle = styled(Text)`
  font-size: 13px;
  color: #8E8E93;
  margin-bottom: 12px;
`;

export const StaticDescription = styled(Text)`
  font-size: 14px;
  color: #333333;
  line-height: 22px;
  margin-bottom: 8px;
...
export const StaticHighlight = styled(Text)`
  font-weight: 700;
  color: #007AFF;
`;

export const StaticWarning = styled(Text)`
  font-weight: 700;
  color: #FF9500;
`;

export const StaticSuccess = styled(Text)`
  font-weight: 700;
  color: #34C759;
`;

export const StaticMetaRow = styled(View)`
  flex-direction: row;
  justify-content: space-between;
  align-items: center;
  margin-top: 8px;
...
export const StaticMetaText = styled(Text)`
  font-size: 12px;
  color: #8E8E93;
`;
